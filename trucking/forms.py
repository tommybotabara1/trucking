...
class DatabaseOperationForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'date': DateInput(attrs={'type': 'date', 'class': 'form-control A', "required": "required"}),
            ...
            'tollfee': NumberInput(attrs={'class': 'form-control', 'step': ".01", "placeholder": "0.00", "max": "999999999999999", "onblur": "matthy(this)", "type": "text"}),
            'parking': NumberInput(attrs={'class': 'form-control', 'step': ".01", "placeholder": "0.00", "max": "999999999999999", "onblur": "matthy(this)", "type": "text"}),
            'entryfee': NumberInput(attrs={'class': 'form-control', 'step': ".01", "placeholder": "0.00", "max": "999999999999999", "onblur": "matthy(this)", "type": "text"}),
            'others': NumberInput(attrs={'class': 'form-control', 'step': ".01", "placeholder": "0.00", "max": "999999999999999", "onblur": "matthy(this)", "type": "text"}),
